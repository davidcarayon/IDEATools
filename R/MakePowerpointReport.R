#' Render a pptx presentation of an IDEA diagnosis
#'
...
#' MakePowerpointReport(path)
MakePowerpointReport <- function(input, output_dir = getwd(), silent = FALSE) {
  ...
  output_file <- paste0(file,"_",basename(tools::file_path_sans_ext(input)),".pptx")
