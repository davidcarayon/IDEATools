#' Render a ODT report of an IDEA diagnosis
#'
...
#' MakeOpenGroupReport(path)
MakeOpenGroupReport <- function(input, output_dir = getwd(), file = "Rapport_groupe", silent = FALSE) {
  ...
  output_file <- paste0(file,"_",Sys.Date(),".odt")
