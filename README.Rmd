...
Deux packages ne sont pas automatiquement installés (afin de réduire la liste des dépendances) mais restent nécessaires pour la production de certains formats de rapports automatiques :
...
Ici par exemple, l'utilisateur n'a pas besoin des figures "brutes", mais a juste besoin pour chaque exploitation d'un rapport au format word qu'il pourra commenter. Le code sera alors :
