...
[![Codecov test coverage](https://codecov.io/gh/davidcarayon/IDEATools/branch/master/graph/badge.svg)](https://codecov.io/gh/davidcarayon/IDEATools?branch=master)
<!-- badges: end -->
...
Il est aussi nécessaire d'installer [LaTeX](latex-project.org) pour la production d'un rapport PDF. Vous pouvez installer une version très allégée (mais suffisante) de LaTeX avec  [tinytex](https://yihui.org/tinytex/).
