...
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Ancrage Territorial.png")), auto_pdf = TRUE)
```

### Autonomie

```{r fig.cap= 'Figure 8 : Arbre éclairé de la propriété "Autonomie"'}
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Autonomie.png")))
```
...
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Capacité productive et reproductive de biens et de services.png")), auto_pdf = TRUE)
```

### Responsabilité globale

```{r fig.cap= 'Figure 10 : Arbre éclairé de la propriété "Responsabilité globale"'}
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Responsabilité globale.png")))
```

### Robustesse

```{r fig.cap= 'Figure 11 : Arbre éclairé de la propriété "Robustesse"'}
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Robustesse.png")), auto_pdf = TRUE)
```

### Arbre complet

```{r fig.cap= 'Figure 12 : Arbre éclairé global de la lecture par les propriétés'}
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Global.png")))
```

### Arbre synthétique

```{r fig.cap= "Figure 13 : Synthèse de la lecture par les propriétés avec un focus sur les premières branches d'agrégation"}
knitr::include_graphics(file.path(outdir,v,"Propriétés","Arbres_éclairés",paste0(v,"_","Global_zoom.png")))
```
