...
IDEApol <- IDEATools::PolarComponent(IDEAdata)
...
## Résultats pour les composantes (polarisée)

\vspace{+3em}

```{r fig.cap= "Version polarisée des résultats par composantes", fig.width = 13, fig.height=13, fig.align="center"}
print(IDEApol[[1]])
```
