...
IDEAresdim <- IDEATools::dimensionsPlots2(IDEAdata)
IDEAresprop <- IDEATools::MakeTrees2(IDEAdata)
IDEAresrad <- IDEATools::radarPlots2(IDEAdata)
# IDEATools::exportIDEA(IDEAresdim,outdir = outdir)
# IDEATools::exportIDEA(IDEAresrad,outdir = outdir)
# IDEATools::exportIDEA(IDEAresprop, outdir = outdir)
